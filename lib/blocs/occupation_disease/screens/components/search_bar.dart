          ...
          child: TextFormField(
            ...
            validator: (value) {
              if (value!.length < 4) {
               ...
               // context.read<OccupationDiseaseBloc>().add(GetOccupationDiseaseFiltered(filter: _filter));
              }
            ...
            onChanged: (value) {
              if(value.length>3){
                context.read<OccupationDiseaseBloc>().add(GetOccupationDiseaseFiltered(filter: value));
              }
            },
