...
import 'package:aeah_work_safety/blocs/occupation_disease/screens/components/occupation_disease_list_view.dart';
...
class OccupationDisease extends StatelessWidget {
  const OccupationDisease({Key? key}) : super(key: key);
        ...
        children: [
          Row(
            children: [
              ...
              RoutingBarWidget(pageName: 'Kronik Hastalık', routeName: occupationDiseasesPageRoute),
            ],
          ),
          ...
          Column(
            ...
            children: [
                      ...
                      return Row(
                        ...
                        [
                          ...
                          state is StatisticLoaded
                              ? (state.statisticResponse.numberOfOccupationDisease)
                                  .toString()
                              : "-",
                          Colors.blueGrey,
                          '-'
                        ...
                        [
                          'Meslek Hast. Çalışan Yüzdesi',
                          '-',
                          Colors.blueGrey.shade700,
                          'MESLEK HASTALIKLI ÇALIŞAN / TOPLAM ÇALIŞAN * 100'
                        ],
              ...
              Constant.dividerWithIndent,
              SizedBox(width: MediaQuery.of(context).size.width - 15, height: 500, child: const OccupationDiseaseListView()),
