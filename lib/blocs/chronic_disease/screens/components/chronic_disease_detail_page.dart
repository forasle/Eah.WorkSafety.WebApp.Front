...
class ChronicDiseaseDetailPage extends StatelessWidget {
  const ChronicDiseaseDetailPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final ChronicDisease _chronicDiseaseDetail = ModalRoute.of(context)?.settings.arguments as ChronicDisease;
        ...
        children: [
          Row(
            children: [
              ...
              RoutingBarWidget(pageName: 'Kronik Hastalıklar', routeName: chronicDiseasesPageRoute),
              const Icon(Icons.arrow_right),
              RoutingBarWidget(pageName: 'Kronik Hastalık', routeName: chronicDiseaseDetailPageRoute),
            ],
          ),
