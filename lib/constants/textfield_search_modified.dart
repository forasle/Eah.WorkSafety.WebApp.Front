...
class TextFieldSearchModified extends StatefulWidget {
  ...
  @override
  _TextFieldSearchModifiedState createState() => _TextFieldSearchModifiedState();
}

class _TextFieldSearchModifiedState extends State<TextFieldSearchModified> {
