...
class Constant {
  ...
  static final List<String> theSubjectOfTheNearMiss = [
  ...
  static const List<FormBuilderFieldOption<String>> theSubjectOfTheNearMiss2 = [
  ...
  static List<String> theSubjectOfTheNearMissToStringList(AffectedEmployeeWithPropertyForNearMiss boolList){
    List<String> result=[];
    if (boolList.theSubjectExposureToPhysicalViolence == true){
      result.add(Constant.theSubjectOfTheNearMiss[0]);
    }
    if (boolList.theSubjectExposureToVerbalViolence == true){
      result.add(Constant.theSubjectOfTheNearMiss[1]);
    }
    if (boolList.theSubjectSharpObjectInjuries == true){
      result.add(Constant.theSubjectOfTheNearMiss[2]);
    }
    if (boolList.theSubjectExposureToBiologicalAgents == true){
      result.add(Constant.theSubjectOfTheNearMiss[3]);
    }
    if (boolList.theSubjectFallingImpactInjuries == true){
      result.add(Constant.theSubjectOfTheNearMiss[4]);
    }
    if (boolList.theSubjectMaterialDamagedTrafficAccident == true){
      result.add(Constant.theSubjectOfTheNearMiss[5]);
    }
    if (boolList.theSubjectInjuredTrafficAccident == true){
      result.add(Constant.theSubjectOfTheNearMiss[6]);
    }
    if (boolList.theSubjectExposureToChemicals == true){
      result.add(Constant.theSubjectOfTheNearMiss[7]);
    }
    if (boolList.theSubjectExposureToFireAndBurn == true){
      result.add(Constant.theSubjectOfTheNearMiss[8]);
    }
    if (boolList.theSubjectOfficeAccidents == true){
      result.add(Constant.theSubjectOfTheNearMiss[9]);
    }
    if (boolList.theSubjectElectricalAccidents == true){
      result.add(Constant.theSubjectOfTheNearMiss[10]);
    }
    return result;
  }
  static List<String> thePrecautionsToBeTakenToStringList(AffectedEmployeeWithPropertyForNearMiss boolList){
    List<String> result=[];
