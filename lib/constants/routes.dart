...
String periodicMedicalExaminationPageRoute =
    '/Panorama/periodicMedicalExamination';
String addNewAccident =
    '/Panorama/nearMiss/addNewAccident';
String addNewNearMiss =
    '/Panorama/nearMiss/addNewNearMiss';
...
String addNewPreventiveActivity =
    '/Panorama/preventiveActivities/addNewPreventiveActivity';
...
String riskAssessmentDetailPage =
    '/Panorama/riskAssessmentPage/riskAssessmentDetailPage';
String addNewRiskAssessment =
    '/Panorama/riskAssessmentPage/addNewRiskAssessment';
